...
Model output from the benchmark runs ponytail published (Claude Haiku 4.5, no-skill arm vs skill arm, temperature 1), with the `ponytail:` marker renamed to `adderall:`. Source: [ponytail benchmarks](https://github.com/DietrichGebert/ponytail/tree/main/benchmarks).

## Without Adderall, 128 lines of code
...
## With Adderall, 10 lines of code
